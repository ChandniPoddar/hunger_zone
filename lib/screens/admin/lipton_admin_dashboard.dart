  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AddItemScreen(outlet: 'Lipton'))),
      ...
      child: Column(
        ...
        children: [
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const VendorPaymentSettingsScreen(initialVendorId: 'lipton'),
                          ),
                        );
                      },
                    ),
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const ChangeAdminCredentialsScreen(initialOutlet: 'Lipton'),
                          ),
                        );
                      },
                    ),
          ...
          Container(
            ...
            child: Text("Lipton Hub", style: GoogleFonts.poppins(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
          ),
      ...
      children: [
        ...
        Consumer<OutletProvider>(
          builder: (context, outletProvider, child) {
            bool isOpen = outletProvider.isOpen('Lipton');
            return Row(
              children: [
                ...
                Switch(
                  value: isOpen,
                  onChanged: (val) => outletProvider.toggleStatus('Lipton'),
      ...
      children: [
        ...
        Expanded(
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ManageItemsScreen(category: 'Lipton'))),
            ...
            children: [
              ClipRRect(
                ...
                child: (items.isNotEmpty && items[0]['imageUrl'] != null && items[0]['imageUrl'].toString().isNotEmpty)
                    ...
                    : Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: Colors.grey[100], borderRadius: BorderRadius.circular(15)), child: const Icon(Icons.emoji_food_beverage, color: Colors.black45)),
              ),
