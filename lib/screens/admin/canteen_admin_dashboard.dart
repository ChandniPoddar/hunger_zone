  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AddItemScreen(outlet: 'Canteen'))),
      ...
      child: Column(
        ...
        children: [
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const VendorPaymentSettingsScreen(initialVendorId: 'canteen'),
                          ),
                        );
                      },
                    ),
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const ChangeAdminCredentialsScreen(initialOutlet: 'Canteen'),
                          ),
                        );
                      },
                    ),
          ...
          Container(
            ...
            child: Text("Canteen Hub", style: GoogleFonts.poppins(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
          ),
          ...
          builder: (context, outletProvider, child) {
            ...
            return Row(
              children: [
                ...
                Switch(
                  value: isOpen,
                  onChanged: (val) => outletProvider.toggleStatus('Canteen'),
      ...
      children: [
        ...
        Expanded(
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ManageItemsScreen(category: 'Canteen'))),
            ...
            children: [
              ClipRRect(
                ...
                child: (items.isNotEmpty && items[0]['imageUrl'] != null && items[0]['imageUrl'].toString().isNotEmpty)
                    ...
                    : Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: Colors.grey[100], borderRadius: BorderRadius.circular(15)), child: const Icon(Icons.restaurant_menu, color: Colors.black45)),
              ),
